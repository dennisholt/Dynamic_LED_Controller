...
// Rev: Program is unstable if calling knobs and buttons that are not connected. Use #if DEV_BOARD to address.
// for Jeanie's Nordic Tree
// String length 126
// top right=30; right bottom=62; bottom left=93; left top=125
#include <Adafruit_NeoPixel.h>
#ifdef __AVR__
  #include <avr/power.h>
#endif
#define DEV_BOARD 0  // 1 to enable debugging button & blinks (slower), 0 to disable for normal running (faster)
